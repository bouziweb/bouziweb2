<?php
    ...
    { 
        ...
        if (empty($array["name"]))
        {
            $array["nameError"] = "I want to know your Last name!";
            $array["isSuccess"] = false; 
        } 
        else
        {
        ...
        {
            $array["emailError"] = "Are you trying to roll me? It's not an email that!";
            $array["isSuccess"] = false; 
        } 
        else
        {
        ...
        {
            $array["phoneError"] = "Only numbers and spaces, Plz ...";
            $array["isSuccess"] = false; 
        }
        else
        {
